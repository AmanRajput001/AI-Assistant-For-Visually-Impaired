...
public class TextRecognition extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    private static final long RIGHT_SWIPE_DELAY = 1000;
    private static final float RIGHT_SWIPE_THRESHOLD = 200;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech.speak("You are on Text Recognition.", TextToSpeech.QUEUE_FLUSH, null, null);
